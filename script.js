...
let srcs = ['card1.png', 'card2.png', 'card3.png', 'card4.png', 'card5.png', 'card1.png', 'card2.png', 'card3.png', 'card4.png', 'card5.png']
...
function time(){
    ...
    setInterval(()=>{
        ...
        if(score.innerHTML == (srcs.length/2)) {
            console.log("you win")
            document.querySelector('#finalTime').innerHTML = `${MM}:${SS}`
            document.querySelector('#board').style.visibility = "hidden";
            document.querySelector('#win_board').style.visibility = "visible";
        } else {
